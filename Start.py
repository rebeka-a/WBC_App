...
st.markdown(
    f"""
    <div style="display: flex; align-items: center; margin-top: -80px; margin-bottom: -2rem;">
        <img src="data:image/png;base64,{encoded_logo}" style="height: 200px; margin-left: -60px;" />
    </div>
    """,
